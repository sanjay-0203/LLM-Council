...
# Benchmark questions covering different domains
BENCHMARK_QUESTIONS = [
    {
...
class CouncilBenchmark:
    ...
    async def _test_voting_method(
        ...
        # Temporarily change voting method
...
if __name__ == "__main__":
    logger.remove()
    logger.add(lambda msg: None)  # Suppress logs during benchmark
